...
|----|--------|----------------|-----------------|-----------------------------|---------|----------------|------------------|---------|--|
| 1  | ![alt text](images/COMPWAH/01.png) | LA2AComp | 01 LA Comp| [Teletronix LA-2A Compressor](https://hookup.co.jp/products/universal-audio/uafx-teletronix-la-2a-studio-compressor) | GAIN | PEAK REDUCTION | LIMIT / COMPRESS ||伝説的なオプティカル・チューブ・リミッターのサウンドを足元で再現。|
