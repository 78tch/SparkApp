...
## 5.[ToneCloudをみてみよう](./ToneCloud.md)
SparkApp の概要が分かったら、ToneCloud で、気になるプリセットを探して、参考にする。  
ToneCloud でのプリセットの探しかた、どういう設定になっているかの分析の手順などについて、[こちら](./ToneCloud.md)にまとめました。
  
## 6.[音作りの手順](./HowToMakePreset.md)
プリセットを自分でつくる手順や注意点について、[こちら](./HowToMakePreset.md)にまとめました。
  
## 7.[バックアップデータの構成・内容](./BackupData.md)
...
## 8.[「プリセット・カテゴリ」を活用したプリセット構築のシナリオ](./Scenario.md)
